...
package com.qc.facialexpressionrecognition.Fragment;
...
import com.qc.facialexpressionrecognition.Helpers.AutoFitTextureView;
import com.qc.facialexpressionrecognition.Helpers.OverlayView;
                ...
                if (faces.length > 0) {
                    for (int i = 0; i < faces.length; i++) {
                        if (faces[i].getScore() > 50) {
                            ...
                            final Bitmap mBitmap = mTextureView.getBitmap(mTextureView.getWidth(), mTextureView.getHeight());
                            getActivity().runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (rect.left > 0 && rect.top > 0 && rect.left < rect.right && rect.top < rect.bottom) {
                                        ...
                                        Bitmap resized = Bitmap.createScaledBitmap(cropped, Constants.BITMAP_WIDTH, Constants.BITMAP_HEIGHT, false);
                                        String text = mSnpeHelper.modelInference(resized);
                                        mOverlayView.setText(text, rect.left, rect.top);
                    ...
                    mOverlayView.setRect(new Rect(0, 0, 0, 0), mPreviewSize.getWidth(), mPreviewSize.getHeight());
            }
        ...
        try {
            ...
            for (String cameraId : mCameraManager.getCameraIdList()) {
                ...
                if (facing == CameraCharacteristics.LENS_FACING_FRONT) {
                    ...
                    Logger.d(TAG, "PRIEVEW " + mPreviewSize.toString());
            ...
            Util.showToast(getString(R.string.error_camera), getActivity());
            Logger.d(TAG, "Camera2 API not supported..");
        }
    }
            ...
            mCameraDevice.createCaptureSession(Arrays.asList(surface),
                    new CameraCaptureSession.StateCallback() {
                        ...
                        public void onConfigureFailed(
                            ...
                            Util.showToast(getString(R.string.toast_failed), getActivity());
                        }
                    }, null
            );
        } catch (CameraAccessException e) {
